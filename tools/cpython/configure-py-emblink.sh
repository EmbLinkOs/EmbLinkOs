...
for m in HAVE_SYS_SOCKET_H HAVE_NETINET_IN_H HAVE_NETINET_TCP_H HAVE_NETDB_H \
         ...
         HAVE_ACCEPT HAVE_RECVFROM HAVE_SENDTO HAVE_SETSOCKOPT HAVE_GETSOCKNAME \
         HAVE_GETPEERNAME HAVE_SHUTDOWN HAVE_GETHOSTNAME HAVE_GETADDRINFO HAVE_GETNAMEINFO \
