...
VELLUM_OBJS := build/vellum.o build/web_html.o build/web_style.o build/web_render.o \
               ...
               build/web_form.o build/web_select.o build/web_cssref.o build/web_cookie.o build/web_store.o
...
html-test:
	$(HOSTCC) -std=c11 -Wall -Wextra -O2 -Iuser/web \
	    ...
	    user/web/cookie.c user/web/store.c \
...
BROWSER_RENDER_SRCS := $(V2_SRC) user/web/html.c user/web/style.c user/web/render.c \
                       ...
                       user/web/form.c user/web/select.c user/web/cookie.c user/web/store.c \
